package br.com.zup.edu.propostas.integration
...
interface FinancialClient {
    ...
    fun submitForAnalysis(request: SubmitForAnalysisRequest): SubmitForAnalysisResponse
...
data class SubmitForAnalysisResponse(
    ...
    fun toModel(): ProposalStatus {
        if ("SEM_RESTRICAO".equals(status)) {
            return ProposalStatus.ELIBLE
        }
        return ProposalStatus.NOT_ELIBLE
    }
